...
public class PeriodListFragment extends ListFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
    	if (item.getItemId() == R.id.addMenu) {
    		...
    		PeriodCreateFragment createFragment = new PeriodCreateFragment();
			createFragment.setTargetFragment(getParentFragment(), 0);
			
			FragmentManager fm = getFragmentManager();
			createFragment.show(fm, PeriodCreateFragment.TAG);			
    	}
    	return true;
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
    	...
    	Toast.makeText(getActivity(), "rámnyomott", Toast.LENGTH_LONG).show();
    }
